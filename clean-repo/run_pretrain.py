...
for ii in range(args.itr):
    ...
    for epoch in range(args.train_epochs):
        ...
        accelerator.print(
            "Epoch: {0} | Train Loss: {1:.7f} Vali Loss: {2:.7f} Test Loss: {3:.7f} MAE Loss: {4:.7f} MAPE Loss: {5:.7f}".format(
                epoch + 1, train_loss, vali_loss, test_loss, test_mae_loss, test_mape_loss))
